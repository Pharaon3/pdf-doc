...
$mpdf->SetTitle(htmlspecialchars($document_title));
$mpdf->SetAuthor('Martin');
...
<body>';
$htmlContent .= '<img src="' . $document_logo . '" alt="Logo" width="50px;">';
    ...
    foreach ($contents as $content) {
        foreach ($content as $key => $cont) {
            if ($key === 'text') {
                ...
                $htmlContent .= '<img src="' . $cont . '" alt="Image">';
            } elseif ($key === 'table') {
                $htmlContent .= '<table>';
                foreach ($cont as $row) {
                    $htmlContent .= '<tr>';
